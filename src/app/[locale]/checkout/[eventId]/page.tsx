...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#070D1E] text-slate-900 dark:text-slate-100 flex flex-col justify-between">
      {/* Checkout Navbar */}
      <header className="sticky top-0 z-30 bg-white/95 dark:bg-[#070D1E]/95 backdrop-blur-md border-b border-slate-200 dark:border-white/10 shadow-2xs">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link
            href={`/e/${event.id}/${event.slug}`}
            className="flex items-center gap-2 text-xs font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-[#00E5FF]"
          >
          ...
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full overflow-hidden bg-slate-100 dark:bg-white/10 border border-slate-200 dark:border-white/10 flex items-center justify-center p-0.5 shadow-xs shrink-0">
                    ...
                    return (
                      <div
                        ...
                        className={`p-4 rounded-2xl border transition ${
                          qty > 0
                            ? 'border-[#00E5FF] bg-cyan-500/10 dark:bg-cyan-950/20'
                      ...
                      >
                        <div className="flex justify-between items-start">
                          ...
                          <span className="font-black text-base text-[#00E5FF]">
                            {ticket.type === 'FREE'
                              ? isRtl
                                ? 'مجاناً'
                                : 'Free'
              ...
              <div className="bg-white dark:bg-white/5 rounded-3xl border border-slate-200 dark:border-white/10 p-6 sm:p-8 space-y-6 shadow-xs">
                ...
                <div className="pt-4 flex justify-between">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-[#00E5FF] to-cyan-400 hover:from-cyan-300 hover:to-[#00E5FF] text-slate-950 font-extrabold text-xs rounded-xl shadow-md shadow-cyan-500/20 transition flex items-center gap-2 cursor-pointer"
                  >
              ...
              <div className="bg-white dark:bg-white/5 rounded-3xl border border-slate-200 dark:border-white/10 p-6 sm:p-8 space-y-6 shadow-xs">
                    ...
                    return (
                      <button
                        ...
                        className={`p-3 rounded-2xl border text-xs font-bold flex flex-col items-center justify-center gap-1 transition-all cursor-pointer ${
                          isSelected
                            ? 'bg-cyan-500/15 text-[#00E5FF] border-[#00E5FF] shadow-lg shadow-cyan-500/20 scale-102'
                ...
                <div className="pt-4 flex justify-between">
                  ...
                  <button
                    ...
                    className="px-8 py-3.5 bg-gradient-to-r from-[#00E5FF] via-cyan-400 to-[#E6AF2E] hover:from-cyan-300 hover:to-amber-400 text-slate-950 font-black text-sm rounded-xl shadow-lg shadow-cyan-500/30 transition flex items-center gap-2 cursor-pointer"
                  >
                    {isSubmitting ? (
            ...
            <div className="bg-white dark:bg-white/5 rounded-3xl border border-slate-200 dark:border-white/10 p-6 shadow-md space-y-5">
              ...
              <div className="pt-3 border-t border-slate-100 dark:border-white/10 space-y-2 text-xs text-slate-600 dark:text-slate-400">
                ...
                <div className="pt-3 border-t border-slate-200 dark:border-white/10 flex justify-between items-baseline font-black text-slate-900 dark:text-white text-base">
                  ...
                  <span className="text-[#00E5FF] inline-flex items-center gap-1">

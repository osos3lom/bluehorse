  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col justify-between">
      <header className="sticky top-0 z-30 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 shadow-2xs">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-xl bg-white dark:bg-[#121C38] border border-slate-200 dark:border-cyan-400/30 flex items-center justify-center p-1 shadow-xs shrink-0">
              ...
              >
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  <Link
                    ...
                    target="_blank"
                    className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 px-4 py-2.5 bg-[#0B132B] dark:bg-[#00E5FF] hover:bg-[#1C2541] dark:hover:bg-cyan-300 text-white dark:text-[#060B18] font-bold text-xs rounded-xl shadow-xs transition"
                  >
      ...
      <footer className="p-4 text-center text-xs text-slate-500">
        Blue Horse Attendee Portal • بوابة حضور بلو هورس
      </footer>
    </div>
  );
}

export type ServiceCategory = 'adventures' | 'nightlife' | 'corporate' | 'events' | 'day-passes' | 'voyages' | 'real-estate';
...
export interface AdventureSpecs {
  ...
  meetingTime: string;
  includedGear: LocalizedString[];
  requiredGear: LocalizedString[];
...
export interface LuxuryProduct {
  ...
  marinaOrArea: 'north_obhur' | 'south_obhur' | 'jeddah_yacht_club' | 'corniche' | 'bayada_reef' | 'durrat_al_arus' | 'moon_mountain' | 'dahaban' | 'desert_valley' | string;
  coverImage: string;
